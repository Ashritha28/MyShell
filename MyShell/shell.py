...
def shell_loop() :
	...
	while status == SHELL_STATUS_RUN :
		...
		if flag == 1 :
			sys.stdout.write("Welcome to MyShell!\n Type prev <line_number> to view the desired line_number th previous command.\n All standard unix commands are available.Please type exit to exit from the shell\n")
			flag =0
